...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    theGuess: function(e){
      ...
      if(guess.match(/[0-9]/) && guess.length == 1){
    ...
    win: function(){
      ...
      // this is messy
      this.msgText.html("Now A special event is coming up :p");
      this.showMsg();
    ...
    lose: function(){
      ...
      this.msgText.html("Don't worry, TRY AGAIN by reloading the page, or visit the next page :p ");
      this.showMsg();
    }
